    ...
    return (
        <div className=" mx-auto  text-center bg-gradient-to-r from-slate-900 to-slate-700 text-white">
            <div className=' pt-8 px-4 container animate-fade-up animate-delay-300 animate-ease-in '>
                ...
                <p className='text-left animate-fade-up animate-delay-300 animate-ease-in'>I graduated in 2024 with a B.Tech in Electronics and Communication Engineering, which provided me with a solid technical background and problem-solving skills. During my studies, I discovered my passion for web development and decided to dive deeper into this dynamic field.</p>

                <h2 className='text-2xl py-3  animate-fade-left animate-delay-300 animate-ease-in'> My Skills</h2>

                <p className='text-left pb-2 animate-fade-up animate-delay-300 animate-ease-in'> <strong>HTML & CSS:</strong> I have a thorough understanding of HTML and CSS, which are the building blocks of web development. I use these technologies to create clean, semantic, and accessible web pages.</p>

                <p className='text-left pb-2 animate-fade-up animate-delay-300 animate-ease-in'> <strong>JavaScript:</strong> JavaScript is my go-to language for adding interactivity and dynamic features to websites. I am proficient in using vanilla JavaScript as well as various libraries and frameworks.</p>

                <p className='text-left pb-2 animate-fade-up animate-delay-300 animate-ease-in'>  <strong>React:</strong> I specialize in React, a powerful JavaScript library for building user interfaces.With React, I create efficient, modular, and maintainable code, ensuring a seamless user experience.</p >

                <p className='text-left pb-2 animate-fade-up animate-delay-300 animate-ease-in'> <strong>Appwrite:</strong> For backend services, I utilize Appwrite, a versatile backend - as - a - service platform.It helps streamline the development process by providing essential backend functionalities, allowing me to focus more on the frontend.</p >
                <h2 className='text-2xl py-3 animate-fade-left animate-delay-300 animate-ease-in'>My Philosophy</h2>
                <p className='text-left animate-fade-up animate-delay-300 animate-ease-in'>In the world of web development, I believe that the user experience is paramount. My goal is to create websites and applications that are not only visually appealing but also intuitive and easy to navigate. I stay updated with the latest trends and technologies to ensure that my work is modern and up-to-date.</p>

                <h2 className='text-2xl py-3 animate-fade-left animate-delay-300 animate-ease-in'>My Projects</h2>
                <p className='text-left animate-fade-up animate-delay-300 animate-ease-in'>Throughout my career, I have worked on various projects, ranging from small personal websites to complex web applications. Each project has taught me something new and helped me grow as a developer. I take pride in my ability to adapt to different challenges and find innovative solutions.</p>
